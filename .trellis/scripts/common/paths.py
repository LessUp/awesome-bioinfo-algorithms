...
def get_spec_dir(package: str | None = None, repo_root: Path | None = None) -> Path:
    ...
    This project uses OpenSpec: openspec/specs/<spec-name>/spec.md
    For backwards compatibility with Trellis scripts, this returns the OpenSpec directory.

    Note: The .trellis/spec/ directory has been removed in favor of openspec/specs/.
    """
    if repo_root is None:
        repo_root = get_repo_root()
